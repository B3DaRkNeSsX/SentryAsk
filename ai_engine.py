...
# ================================================
# CLIENT GROQ
# La chiave viene letta da .env / variabile d'ambiente.
# Se assente, viene usata la chiave di backup hardcoded
# in modo che l'app funzioni sempre in fase dimostrativa.
# ================================================
GROQ_BASE_URL  = "https://api.groq.com/openai/v1"
GROQ_MODEL     = "llama-3.1-8b-instant"   # aggiornato: llama3-8b-8192 è stato dismesso
_FALLBACK_KEY  = "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"

def _get_client() -> OpenAI:
    """
    Restituisce sempre un client Groq valido.
    Priorità: variabile d'ambiente > chiave hardcoded di backup.
    """
    api_key = os.getenv("GROQ_API_KEY") or _FALLBACK_KEY
